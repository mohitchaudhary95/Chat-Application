 ...
 useEffect(() => {
  ...
  const handleSendMessage = () => {
    ...
    if (selectedChatType === 'contact' && socket) {
      ...
      socket.emit("send-channle-message", {
        sender: userInfo.id,
        content: message,
        messageType: "text",
        fileUrl: undefined,
  ...
  return (
    ...
    <button className="bg-[#8417ff] rounded-md flex items-center justify-center p-5 focus:border-none hover:bg-[#742bda] focus:bg-[#741bda] focus:outline-none focus:text-white duration-300 transition-all "
