...
const NewDM = () => {
  ...
  const searchContacts = async (searchTermValue) => {
    try {
    ...
    <>
      ...
      <Dialog open={openNewContact} onOpenChange={setOpenNewContact}>
        <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col ">
          <DialogHeader>
            <DialogTitle>Please selct a contact</DialogTitle>
          ...
          </div>
          {
            ...
            <div className="flex flex-col gap-5">
              {searchedContacts.map((contact) => (
                <div
                  key={contact._id}
                  className="flex  gap-3 items-center cursor-center"
          ...
          {searchedContacts.length <= 0 && (
            <div>
              <div className="flex-1 md:flex flex-col mt-5 justify-center items-center hidden duration-1000 transition-all">
                <Lottie
